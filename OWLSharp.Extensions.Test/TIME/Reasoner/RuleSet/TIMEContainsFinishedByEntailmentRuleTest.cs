...
[TestClass]
public class TIMEContainsFinishedByEntailmentRuleTest : TIMETestOntology
{
    #region Tests
    [TestMethod]
    public async Task ShouldExecuteTIMEContainsFinishedByEntailmentRule()
    {
        ...
        List<OWLInference> inferences = await TIMEContainsFinishedByEntailmentRule.ExecuteRuleAsync(ontology);
    ...
    [TestMethod]
    public async Task ShouldExecuteTIMEContainsFinishedByEntailmentRuleViaReasoner()
    {
        OWLOntology ontology = new OWLOntology(TestOntology);
        ontology.DeclareIntervalFeature(new RDFResource("ex:Feature1"), new TIMEInterval(new RDFResource("ex:Interval1")));
        ontology.DeclareIntervalFeature(new RDFResource("ex:Feature2"), new TIMEInterval(new RDFResource("ex:Interval2")));
        ...
        TIMEReasoner reasoner = new TIMEReasoner().AddRule(TIMEEnums.TIMEReasonerRules.ContainsFinishedByEntailment);

...
[TestClass]
public class TIMEEqualsOverlapsEntailmentRuleTest : TIMETestOntology
{
    #region Tests
    [TestMethod]
    public async Task ShouldExecuteTIMEEqualsOverlapsEntailmentRule()
    {
        ...
        List<OWLInference> inferences = await TIMEEqualsOverlapsEntailmentRule.ExecuteRuleAsync(ontology);
    ...
    [TestMethod]
    public async Task ShouldExecuteTIMEEqualsOverlapsEntailmentRuleViaReasoner()
    {
        OWLOntology ontology = new OWLOntology(TestOntology);
        ontology.DeclareIntervalFeature(new RDFResource("ex:Feature1"), new TIMEInterval(new RDFResource("ex:Interval1")));
        ontology.DeclareIntervalFeature(new RDFResource("ex:Feature2"), new TIMEInterval(new RDFResource("ex:Interval2")));
        ...
        TIMEReasoner reasoner = new TIMEReasoner().AddRule(TIMEEnums.TIMEReasonerRules.EqualsOverlapsEntailment);

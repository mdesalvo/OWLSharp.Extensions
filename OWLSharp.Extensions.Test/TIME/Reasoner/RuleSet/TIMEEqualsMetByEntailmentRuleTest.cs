...
[TestClass]
public class TIMEEqualsMetByEntailmentRuleTest : TIMETestOntology
{
    #region Tests
    [TestMethod]
    public async Task ShouldExecuteTIMEEqualsMetByEntailmentRule()
    {
        ...
        List<OWLInference> inferences = await TIMEEqualsMetByEntailmentRule.ExecuteRuleAsync(ontology);
    ...
    [TestMethod]
    public async Task ShouldExecuteTIMEEqualsMetByEntailmentRuleViaReasoner()
    {
        OWLOntology ontology = new OWLOntology(TestOntology);
        ontology.DeclareIntervalFeature(new RDFResource("ex:Feature1"), new TIMEInterval(new RDFResource("ex:Interval1")));
        ontology.DeclareIntervalFeature(new RDFResource("ex:Feature2"), new TIMEInterval(new RDFResource("ex:Interval2")));
        ...
        TIMEReasoner reasoner = new TIMEReasoner().AddRule(TIMEEnums.TIMEReasonerRules.EqualsMetByEntailment);

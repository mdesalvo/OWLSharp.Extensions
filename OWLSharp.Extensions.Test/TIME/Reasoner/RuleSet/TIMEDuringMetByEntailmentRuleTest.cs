...
[TestClass]
public class TIMEDuringMetByEntailmentRuleTest : TIMETestOntology
{
    #region Tests
    [TestMethod]
    public async Task ShouldExecuteTIMEDuringMetByEntailmentRule()
    {
        ...
        List<OWLInference> inferences = await TIMEDuringMetByEntailmentRule.ExecuteRuleAsync(ontology);
    ...
    [TestMethod]
    public async Task ShouldExecuteTIMEDuringMetByEntailmentRuleViaReasoner()
    {
        OWLOntology ontology = new OWLOntology(TestOntology);
        ontology.DeclareIntervalFeature(new RDFResource("ex:Feature1"), new TIMEInterval(new RDFResource("ex:Interval1")));
        ontology.DeclareIntervalFeature(new RDFResource("ex:Feature2"), new TIMEInterval(new RDFResource("ex:Interval2")));
        ...
        TIMEReasoner reasoner = new TIMEReasoner().AddRule(TIMEEnums.TIMEReasonerRules.DuringMetByEntailment);
